...
@register_model_architecture(model_name="s2t_transformer", arch_name="s2t_transformer_small")
def s2t_transformer_small(args):
    # Transformer
...
@register_model_architecture(model_name="s2t_transformer", arch_name="s2t_transformer_small_1")
def s2t_transformer_small_1(args):
    args.encoder_freezing_updates = getattr(args, "encoder_freezing_updates", 0)
    # Convolutional subsampler
...
@register_model_architecture("s2t_transformer", "s2t_transformer_xs_cnn")
def s2t_transformer_xs_cnn(args):

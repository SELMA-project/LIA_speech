...
from speechbrain.dataio.dataio import merge_char, split_word, keep_concepts
...
class ErrorRateStats(MetricStats):
    ...
    def __init__(self, merge_tokens=False, split_tokens=False, space_token="_", keep_concepts=False):
        self.clear()
        self.merge_tokens = merge_tokens
        self.split_tokens = split_tokens
        self.space_token = space_token
        self.keep_concepts = keep_concepts # keep only semantic concepts for concept error rate
    ...
    def append(
        ...
        * See MetricStats.append()
        ...
        if self.keep_concepts: # keep only concepts for concept error rate evaluation
